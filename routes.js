...
module.exports = [
    ...
    { method: 'GET', path: '/socialcategory/{cat}', config: Places.socialPlacesByCategory },
    { method: 'GET', path: '/place/{id}', config: Places.onePlace },
    { method: 'GET', path: '/socialplace/{id}', config: Places.onePlaceSocial },
    { method: 'GET', path: '/shareplace/{id}', config: Places.sharePlace },      
    { method: 'GET', path: '/makeprivate/{id}', config: Places.makePrivate },         
    ...
    { method: 'GET', path: '/socialcategory', config: Places.socialCategory },      
    { method: 'GET', path: '/places/{_id}', config: Places.places },
    { method: 'GET', path: '/adminplaces/{_id}', config: Places.adminPlaces },    
    { method: 'GET', path: '/placesbycat/{cat}', config: Places.placesByCategory },          
